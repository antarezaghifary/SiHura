package com.project.sihurahura.ui.KelasKaryawan
...
import com.project.sihurahura.databinding.ActivityKelasKaryawanBinding

class KelasKaryawanActivity : AppCompatActivity() {
    private val binding: ActivityKelasKaryawanBinding by viewBinding()
        ...
        with(binding) {
            ...
            binding.appBarInformasi.addOnOffsetChangedListener(AppBarLayout.OnOffsetChangedListener { barLayout, verticalOffset ->
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbar.title = "Kelas Keryawan"
